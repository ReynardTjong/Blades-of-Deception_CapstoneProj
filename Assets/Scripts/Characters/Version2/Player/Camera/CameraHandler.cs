        ...
        public void HandleLockOn()
        {
            ...
            for (int k = 0; k < availableTargets.Count; k++)
            {
                ...
                if (inputHandler.lockOnFlag)
                {
                    ...
                    var distanceFromLeftTarget = currentLockOnTarget.transform.position.x + relativeEnemyPosition.x - availableTargets[k].transform.position.x;
                    var distanceFromRightTarget = currentLockOnTarget.transform.position.x - relativeEnemyPosition.x - availableTargets[k].transform.position.x;
